    ...
    <div className="dashboard-stack">
      <header className="page-title">
        <div className="page-title-copy">
          ...
          <p className="dashboard-subtitle">{customer.phoneMasked} - {customer.cpfMasked ?? "CPF não informado"}</p>
        </div>
      ...
      <section className="panel"><div className="panel-header"><h2 className="section-heading"><History size={19} /> Histórico</h2></div>
        {customer.transactions.length === 0 ? <div className="empty-state"><span className="empty-state-icon"><History size={22} /></span><p>Nenhuma movimentação para este cliente.</p></div> : <div className="table-wrap"><table className="responsive-table"><thead><tr><th>Data</th><th>Tipo</th><th>Origem</th><th>Pontos</th><th>Motivo</th></tr></thead><tbody>
