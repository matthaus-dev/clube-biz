  ...
  return (
    <div className="dashboard-stack">
      <header className="page-title">
        <div className="page-title-copy"><p className="eyebrow">Clientes</p><h1>Cartoes fidelidade</h1><p className="dashboard-subtitle">Consulte saldos e acompanhe cada relacionamento.</p></div>
      ...
      <section className="panel">
        ...
        {data.nextCursor && <Link className="next-link" href={`/painel/clientes?cursor=${data.nextCursor}${params.q ? `&q=${encodeURIComponent(params.q)}` : ""}`}>Proxima pagina</Link>}
      </section>
    </div>
  );
}
